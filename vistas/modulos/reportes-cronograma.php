...
<div class="content-wrapper">
  ...
  <div class="pad margin no-print">
    <div class="callout callout-info" style="margin-bottom: 0!important;">
      ...
      En esta sección podemos vizualizar los detalles del reporte
    </div>
  </div>
  <!-- Main content -->
  <section class="invoice">
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        ...
        <b>Clínica:</b> <?php echo $usuarios['nombre'];?><br>
        ...
        <b>Código:</b> <?php echo $reportes['codigo'];?><br>
      </div>
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <h4>Mantenimientos</h4><br>
    ...
    <div class="row">
       ...
       <!--  <div class="box-header with-border">
          ...
          <?php
            ...
            if ($mediciones["principalventilador"] == "Ventilador" && $mediciones["adulto"] == "adulto") {
              ...
              }else if ($mediciones["principalventilador"] == "Ventilador" && $mediciones["pediatrico"] == "pediatrico") {
                echo 
                '
              ...
              }else if ($mediciones["principalventilador"] == "Ventilador" && $mediciones["neonatal"] == "neonatal") {
                echo 
                '
              ...
              }else if($mediciones["principalvacu"] == "Succionador Vacuometro" && $mediciones["mmHg"] == "mmHg"){
              ...
              }else if ($mediciones["principalvacu"] == "Succionador Vacuometro" && $mediciones["inHg"] == "inHg") {
                echo 
                '
                  <h4>Tabla de Resultados</h4>
                    <table class="table table-hover">
              ...
              }else if ($mediciones["principalvacu"] == "Succionador Vacuometro" && $mediciones["Mpa"] == "Mpa") {
                echo 
                '
                  <h4>Tabla de Resultados</h4>
                    <table class="table table-hover">
              ...
              }else if ($mediciones["principalvacu"] == "Succionador Vacuometro" && $mediciones["nueva"] == "nueva") {
                echo 
                '
                  <h4>Tabla de Resultados</h4>
                    <table class="table table-hover">
              ...
              else if($mediciones["principalmon"] == "Monitor Multiparametros" && $mediciones["neonatalmonitor"] == "neonatalmonitor"){
              ...
              }else if ($mediciones["principalmon"] == "Monitor Multiparametros" && $mediciones["pediatricomonitor"] == "pediatricomonitor") {
                echo 
                ' 
                  <h4>Monitor Multiparametros</h4>
                    <table class="table table-hover table-bordered">
              ...
              }else if ($mediciones["principalmon"] == "Monitor Multiparametros" && $mediciones["adultomonitor"] == "adultomonitor") {
                echo 
                ' 
                  <h4>Monitor Multiparametros</h4>
                    <table class="table table-hover table-bordered">
              ...
              }else if ($mediciones["principalbasculas"] == "basculas" && $mediciones["kg"] == "kg") {
              ...
              }else if ($mediciones["principalbasculas"] == "basculas" && $mediciones["g"] == "g") {
                echo 
                '
                <h4>Tabla de Resultados</h4>
                    <table class="table table-hover table-bordered">
              ...
              }else if ($mediciones["Termohigrometros"] == "Termohigrometros") {
              ...
              }else if ($mediciones["principalincu"] == "Incubadora" && $mediciones["centigrado"] == "centigrado") {
                echo 
              '<h4>Tabla de Resultados</h4>
                <table class="table table-hover table-bordered">
                          <tr>
              ...
              }else if ($mediciones["principalincu"] == "Incubadora" && $mediciones["farenheit"] == "farenheit") {
                 echo 
              '<h4>Tabla de Resultados</h4>
                <table class="table table-hover table-bordered">
                          <tr>
              ...
              }else if ($mediciones["principalpipeta"] == "Pipeta" && $mediciones["apto"] == "apto") {
                echo 
                '<h4>Pipeta</h4>
                    <table class="table table-hover table-bordered">
                          <tr>
              ...
              }else if ($mediciones["principalpipeta"] == "Pipeta" && $mediciones["noapto"] == "noapto") {
                echo 
                '<h4>Pipeta</h4>
                    <table class="table table-hover table-bordered">
                          <tr>
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          echo '<img src="vistas/img/firmas/defecto/defecto.png" width="30%" alt="Firma"><br>';
          }
          ?>
        </div>
        <!-- /.col -->
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <button type="button" class="btn btn-primary pull-right btnGenerarPdf" codigoReporteNuevo="<?php echo $reportes['num_reporte'] ?>" style="margin-right: 5px;">
