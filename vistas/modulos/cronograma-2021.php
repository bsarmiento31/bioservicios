...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Cronogramas 2021</li> 
    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="box-header with-border">
          ...
          <a href="vistas/modulos/descargar-reporte.php?reporte14=reporte14"><button class="btn btn-success">Descargar reporte en Excel</button></a>
          ...
          <tbody>
            ...
            echo '<tr>';
              ...
              <div class="popover_parent">';
                ...
                $tiempo = "tiempo";
                $valortiempo = "2021";
                $reportessi = ControladorMantenimiento::ctrMostrarModelos2021($item, $valor,$orden,$perfil,$tiempo,$valortiempo);
     ...
     <!--   </div>-->
       ...
       <div class="box-footer clearfix no-border">
              <a href="http://ingbioservicios.com.co/app/cronograma-2020"><button type="button" class="btn btn-default"><i class="fa fa-chevron-left"></i> 2020</button></a>
        </div>
