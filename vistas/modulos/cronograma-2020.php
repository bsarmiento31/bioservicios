...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Cronogramas 2020</li> 
    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="box-header with-border">
          ...
          <a href="vistas/modulos/descargar-reporte.php?reporte13=reporte13"><button class="btn btn-success">Descargar reporte en Excel</button></a>
          ...
          <tbody>
            ...
            echo '<tr>';
              ...
              <div class="popover_parent">';
                ...
                $tiempo = "tiempo";
                $valortiempo = "2020";
                $reportessi = ControladorMantenimiento::ctrMostrarModelos2020($item, $valor,$orden,$perfil,$tiempo,$valortiempo);
     ...
     <!--   </div>-->
        ...
        <div class="box-footer clearfix no-border">
              <a href="http://ingbioservicios.com.co/app/cronograma-2021"><button type="button" class="btn btn-default pull-right">2021 <i class="fa fa-chevron-right"></i></button></a>
              <a href="http://ingbioservicios.com.co/app/cronograma"><button type="button" class="btn btn-default"><i class="fa fa-chevron-left"></i> 2019</button></a>
        </div>
      ...
      <div class="box-header with-border">
          ...
          <?php
       $session = $_SESSION["id"];
        echo ' <a href="vistas/modulos/descargar-reporte.php?reporte13=reporte13&session='.$session.'"><button class="btn btn-success botones">Descargar reporte en Excel</button></a>'
       ?>
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <div class="input-group">
              ...
              <select class="form-control input-lg" name="clienteCronograma" id="nuevoClienteM">
                <?php
                $item = null;
                $valor = "cliente";
                $perfil = "perfil";
          ...
          <div class="form-group">
            <div class="input-group">
              <span class="input-group-addon"><i class="fa fa-align-justify"></i></span>
              <select class="form-control input-lg select2 validarSerie" style="width: 100%;" name="nuevoSerie" id="nuevoSerieM">
                <?php
          ...
          <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <span class="input-group-addon"><i class="fa fa-align-justify"></i></span>
                    <select class="form-control input-lg" name="nuevoPeriodo" required>
        ...
        <div class="box-body">
          ...
          <div class="form-group"  style="display:none;">
            <div class="input-group">
              ...
              <span class="input-group-addon"><i class="fa fa-users"></i></span>
              <select class="form-control input-lg" id="clienteCronogramaEditar" name="clienteCronogramaEditar" readonly>
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              <div class="form-group">
                    ...
                    <label>
                      <input type="checkbox" name="eneroEditar" id="eneroEditar" value="enerocr">  Enero
                    </label>
                    <label>
                      <input type="checkbox" name="febreroEditar" id="febreroEditar" value="febrerocr">  Febrero
                    </label>
                    <label>
                      <input type="checkbox" name="marzoEditar" id="marzoEditar" value="marzocr">  Marzo
                    </label>       
                  </div>
              </div>
              ...
              <div class="col-md-3">
                    ...
                    <label>
                      <input type="checkbox" name="abrilEditar" id="abrilEditar" value="abrilcr">  Abril
                    </label>
                    <label>
                      <input type="checkbox" name="mayoEditar" id="mayoEditar" value="mayocr">  Mayo  
                    </label>
                    <label>
                      <input type="checkbox" name="junioEditar" id="junioEditar" value="juniocr">  Junio
                    </label>
              ...
              <div class="col-md-3">
                ...
                <label>
                      <input type="checkbox" name="julioEditar" id="julioEditar" value="juliocr">  Julio
                    </label>
                    <label>
                      <input type="checkbox" name="agostoEditar" id="agostoEditar" value="agostocr">  Agosto
                    </label>
                    <label>
                      <input type="checkbox" name="septiembreEditar" id="septiembreEditar" value="septiembrecr">  Septiembre
                </label>     
              </div>
              ...
              <div class="col-md-3">
                    ...
                    <label>
                      <input type="checkbox" name="octubreEditar" id="octubreEditar" value="octubrecr">  Octubre
                    </label>
                    <label>
                      <input type="checkbox" name="noviembreEditar" id="noviembreEditar" value="noviembrecr">  Noviembre
                    </label>
                    <label>
                      <input type="checkbox" name="diciembreEditar" id="diciembreEditar" value="diciembrecr">  Diciembre
                    </label>
              </div>
          </div>
        ...
        <div class="box-body">
          ...
          <div class="form-group" style="display: none;">
            <div class="input-group">
              ...
              <span class="input-group-addon"><i class="fa fa-users"></i></span>
              <select class="form-control input-lg" id="clienteCronograma" name="clienteCronogramaperiodo">
